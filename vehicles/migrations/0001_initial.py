    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_type', models.CharField(choices=[('cycle', 'Cycle'), ('scooter', 'Scooter'), ('motorcycle', 'Motorcycle'), ('auto_rickshaw', 'Auto Rickshaw'), ('car', 'Car'), ('jeep', 'Jeep'), ('bus', 'Bus'), ('truck', 'Truck')], default='motorcycle', max_length=50)),
